...
const actualizarEstado = ({id, estado}) => {
    ClientService.cambiarEstado(id, {estado: !estado})
    .then(() => {
...
<template>
    <div>
        ...
        <h1 class="text-4xl font-extrabold text-slate-500"> Listado de Clientes</h1>
          ...
          <div class="min-w-full py-2 align-middle sm:px-6 lg:px-8">
              <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                        <Cliente v-for="cliente in clientes" :key="cliente.id" :cliente="cliente" @actualizar-estado="actualizarEstado" @eliminar-cliente="eliminarCliente"/>
                  </tbody>
              </table>
          </div>
      </div>
